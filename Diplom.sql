...
(
	...
	--constraint [CH_Spisok_Rapot_Cyrill_Upper] check ([Spisok_Rapot] like ('%[А-Я]%')),
	--constraint [CH_Spisok_Rapot_Cyrill_Lower] check ([Spisok_Rapot] like ('%[а-я]%')),
	--constraint [CH_Spisok_Rapot_Spec_Numbers] check ([Spisok_Rapot] like ('%[0-9]%')),
	--constraint [CH_Spisok_Materialov_Cyrill_Upper] check ([Spisok_Materialov] like ('%[А-Я]%')),
	--constraint [CH_Spisok_Materialov_Cyrill_Lower] check ([Spisok_Materialov] like ('%[а-я]%')),
	--constraint [CH_Spisok_Materialov_Spec_Numbers] check ([Spisok_Materialov] like ('%[0-9]%')),
	--constraint [CH_Kommentariy_TT_Cyrill_Upper] check ([Kommentariy_TT] like ('%[А-Я]%')),
	--constraint [CH_Kommentariy_TT_Cyrill_Lower] check ([Kommentariy_TT] like ('%[а-я]%')),
	--constraint [CH_Kommentariy_TT_Spec_Numbers] check ([Kommentariy_TT] like ('%[0-9]%')),
	--constraint [CH_Kommentariy_Group_Cyrill_Upper] check ([Kommentariy_Group] like ('%[А-Я]%')),
	--constraint [CH_Kommentariy_Group_Cyrill_Lower] check ([Kommentariy_Group] like ('%[а-я]%')),
...
create view [dbo].[View_Group]("№ Группы","ФИО","Дата")
as
SELECT 
	dbo.[Group].ID_Group, 
